  ...
  return (
    <div>
      <div className='relative flex bg-[#111111] h-32 justify-center items-center'>
        <p className='max-big:hidden absolute left-5 font-sans font-medium'>Created By <span className='text-[orange]'>- Valton Kasami</span></p>
    ...
    <p className='font-sans font-medium absolute right-5 max-big:hidden'>@2023 - All rights are reserved</p>
    </div>
    </div>
  )
}